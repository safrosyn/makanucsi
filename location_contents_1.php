...
<?php
      $query = "SELECT * FROM food_items WHERE (food_location_id='1')";
...
<?php
      $oquery = "SELECT * FROM location WHERE (location_id='1')";
...
?>
    <div class="menu-item">
        ...
        <div class="item-name"><h5><?php echo $cols['location_time']; ?></div>
